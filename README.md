...
- EXE 应用隔离区：`desktop_app/` 专门用于后续桌面打包，不污染主应用。
...
- [Desktop App Workspace](desktop_app/README.md)
...
- Isolated desktop application workspace under `desktop_app/` for future EXE packaging.
